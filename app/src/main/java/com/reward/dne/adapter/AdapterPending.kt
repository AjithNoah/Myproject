...
class AdapterPending(val context: Context, val list: ArrayList<Offerlist>) : RecyclerView.Adapter<AdapterPending.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): AdapterPending.ViewHolder {
    ...
    override fun onBindViewHolder(holder: AdapterPending.ViewHolder, position: Int) {
        ...
        holder.textDescription.text = "Pending Verification"
